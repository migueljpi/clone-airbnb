...
tour_data = [
  ...
  { name: "Berlin Alternative Tour", location: "Berlin", guide: guide6, description: "Explore Berlin’s street art and alternative scene.", price: 45, category: "Walking Tour", photo_url: "https://images.unsplash.com/photo-1587330979470-3595ac045ab0?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", starting_point: "Kreuzberg, Berlin, Germany", sights: "Mauerpark, Berlin, Germany; RAW-Gelände, Berlin, Germany; Friedrichshain, Berlin, Germany; Berghain, Berlin, Germany", ending_point: "East Side Gallery, Berlin, Germany" },
